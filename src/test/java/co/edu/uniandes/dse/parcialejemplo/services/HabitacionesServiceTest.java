...
class HabitacionesServiceTest {
	 ...
	 */
	@Test
	void testCreateHabitaciones() throws EntityNotFoundException, IllegalOperationException {
		HabitacionesEntity newEntity = factory.manufacturePojo(HabitacionesEntity.class);
		HabitacionesEntity result = habitacionService.createHabitacion(newEntity);
		assertNotNull(result);

		HabitacionesEntity entity = entityManager.find(HabitacionesEntity.class, result.getId());
